...
<body id="page-top">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<a class="btn btn-primary" href="new_customer">Create New Customer</a>
						</div>
						<div class="card-body">
									...
									<tbody>
										<c:forEach items="${listCustomer }" var="customer" varStatus="status">
											<tr>
												...
												<td>
													<a class="btn btn-warning" href="edit_customer?id=${customer.customerId }">Update</a>
													<a class="btn btn-danger" href="javascript:confirmDelete(${customer.customerId })">Delete</a>
												</td>
											</tr>
										</c:forEach>
	...
	<script>
		function confirmDelete(customerId){
			if(confirm('Are you sure to delete this customer with Id ' + customerId + '?')){
